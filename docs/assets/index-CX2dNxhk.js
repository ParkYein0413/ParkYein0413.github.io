...
`,NV=lt.div`
    ...
    padding-bottom:64px;
    item-align:center;
`;function jv(n){return Z.jsx("div",{children:Z.jsx(RV,{children:Z.jsxs(CV,{children:[Z.jsx(NV,{children:Z.jsx("img",{src:"/wda-miniblog//profile.jpg"})}),Z.jsxs(rR,{children:[Z.jsx(pm,{children:"POST"}),Z.jsx(pm,{children:"CALENDER"}),Z.jsx(pm,{children:"NEIGHBOR"})]}),Z.jsx(PV,{children:Z.jsx(DV,{children:"SETTING"})})]})})})}const xV=lt.div`
  overflow-y: scroll;
  width:1090px;
